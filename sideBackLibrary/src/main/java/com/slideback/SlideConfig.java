...
public class SlideConfig {
    ...
    public SlideConfig setEdgeOnly(boolean edgeOnly) {
        mEdgeOnly = edgeOnly;
        return this;
    }

    public SlideConfig setLock(boolean lock) {
        mLock = lock;
        return this;
    }

    public SlideConfig setEdgePercent(float edgePercent) {
        mEdgePercent = edgePercent;
        return this;
    }

    public SlideConfig setSlideOutPercent(float slideOutPercent) {
        mSlideOutPercent = slideOutPercent;
        return this;
    }

    public SlideConfig setSlideOutVelocity(float slideOutVelocity) {
        mSlideOutVelocity = slideOutVelocity;
        return this;
    }

    public SlideConfig setRotateScreen(boolean rotateScreen) {
        mRotateScreen = rotateScreen;
        return this;
    }
